...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            // 3. 插入 ak sk
            String ak = DigestUtil.md5Hex(SALT + System.currentTimeMillis() / 1000 + RandomUtil.randomNumbers(3));
            String sk = DigestUtil.md5Hex(System.currentTimeMillis() / 1000 + SALT + RandomUtil.randomNumbers(3));
