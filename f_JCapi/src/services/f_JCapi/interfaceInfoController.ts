...
/** invokeInterfaceInfo POST /api/interfaceInfo/invokeInterface */
export async function invokeInterfaceInfoUsingPost(
  body: API.InterfaceInfoInvokeRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseobject>('/api/interfaceInfo/invokeInterface', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** listDeletedInterfaceInfo GET /api/interfaceInfo/listDeleted */
export async function listDeletedInterfaceInfoUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.listDeletedInterfaceInfoUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseListInterfaceInfo>('/api/interfaceInfo/listDeleted', {
    method: 'GET',
    params: {
      ...params,
    },
