...
/** getUserAkSk GET /api/user/get/userAk */
export async function getUserAkSkUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponseUserAkSkVO>('/api/user/get/userAk', {
    method: 'GET',
    ...(options || {}),
  });
}
...
/** userUpdateKey POST /api/user/updateKey */
export async function userUpdateKeyUsingPost(
  body: API.UserUpdateKeyRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseboolean>('/api/user/updateKey', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
